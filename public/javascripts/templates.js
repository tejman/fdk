...
with (locals || {}) {
var interp;
buf.push('<div class="row"><div class="col-md-2 filter-item"><span class="filter-label">Poverty: <span class="label-value value-min">0</span><span class="theto">to</span><span class="label-value value-max">100</span></span><div class="slider-stat ui-slider"></div></div><div class="col-md-2 filter-item"><span class="filter-label">Poverty: <span class="label-value value-min">0</span><span class="theto">to</span><span class="label-value value-max">100</span></span><div class="slider-stat ui-slider"></div></div><div class="col-md-2 filter-item"><span class="filter-label">Poverty: <span class="label-value value-min">0</span><span class="theto">to</span><span class="label-value value-max">100</span></span><div class="slider-stat ui-slider"></div></div><div class="col-md-2 filter-item"><span class="filter-label">Poverty: <span class="label-value value-min">0</span><span class="theto">to</span><span class="label-value value-max">100</span></span><div class="slider-stat ui-slider"></div></div><div class="col-md-2 filter-item"><span class="filter-label">Poverty: <span class="label-value value-min">0</span><span class="theto">to</span><span class="label-value value-max">100</span></span><div class="slider-stat ui-slider"></div></div><div class="col-md-2 filter-item"><span class="filter-label">Poverty: <span class="label-value value-min">0</span><span class="theto">to</span><span class="label-value value-max">100</span></span><div class="slider-stat ui-slider"></div></div></div>');
}
return buf.join("");
}
...
with (locals || {}) {
var interp;
buf.push('<div class="col-md-12"><span class="filter-actions"><button id="update-filter" class="btn btn-embossed btn-primary">Update</button><button id="reset-filter" class="btn btn-embossed btn-default">Reset</button></span><span id="filter-button" class="glyphicon glyphicon-filter"></span><strong class="query-label">' + escape((interp = label) == null ? '' : interp) + '</strong><span class="query-value">' + escape((interp = value) == null ? '' : interp) + '</span></div>');
}
return buf.join("");
}
